...
export const CONTEXT_EVENTS: ContextEvent[] = [
  ...
  },
  {
    ...
    severity:"high", state:"replanned", auto:"Partial",
    title:"RS-02 spreader fault — 8 moves redistributed",
    detail:"Reach stacker RS-02 reported a spreader locking fault at Zone B-03. Eight assigned moves redistributed to RS-01 (5) and RS-03 (3). One IMDG retrieval escalated because OP-114 is the sole IMDG-certified operator on shift. Maintenance ticket raised — estimated repair 45 min.",
    diff:{ cancelled:0, added:1, reassigned:8, frozenKept:4, deltaMin:22, adherence:-3 },
    story:false,
  },
  {
  ...
  },
  {
    ...
    severity:"high", state:"awaiting", auto:"Manual",
    title:"COSU1000058 not at logged address B-04-2-9-2",
    detail:"OP-502 reported the slot empty on arrival. Linked retrieval order held; guided search raised against Zone B with four ranked candidate addresses. Cycle-count task YA-312 created. Requires yard-manager acknowledgement before the plan is re-cut.",
  ...
  },
  {
    ...
    severity:"high", state:"replanned", auto:"Auto",
    title:"OOLU1000074 — last-free-day passed 12 h ago",
    detail:"OOCL Tier 2 rate activated at $92/day. Retrieval sequenced for 08:45 with the reserved staging slot S-01-1-6-1 released to back-fill. Accrued $1 104 posted to the exposure ledger; empty-return window at Sur Empty Park is 08:00–17:00.",
  ...
  },
  {
    ...
    detail:"AFIP raised a physical inspection order on YMLU1000081 (auto-parts, DUA-2026-08-13-00882). Container moved to Zone C inspection bay; retrieval slot deferred 4 hours. Consignee Magna Rosario notified; AFIP verifier appointment confirmed for 11:00.",
  ...
  },
  {
    ...
    severity:"high", state:"replanned", auto:"Auto",
    title:"YMLU1000093 assigned red channel — DGA clearance required",
    detail:"ARCA returned red selectivity for YMLU1000093 (chemical precursors). DGA physical inspection mandatory before release. Container moved to Zone D awaiting armed customs verifier. Dwell forecast extended 6.2 days; putaway slot switched to hazmat row.",
    diff:{ cancelled:1, added:3, reassigned:1, frozenKept:0, deltaMin:15, adherence:-2 },
    story:false,
  },
  {
